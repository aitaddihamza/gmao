...
class CalendarWidget extends FullCalendarWidget
{
    ...
    public function refreshCalendar()
    {
        ...
        $this->js(
            'window.dispatchEvent(new Event("filament-full-calendar::refresh"))'
        );
    }
        ...
        return [
            Actions\CreateAction::make()
                ...
                ->action(function (array $data, Forms\Form $form): void {
                    ...
                    try {
                        Log::info(
                            'Tentative d\'envoi de notification pour la maintenance: ' .
                                $record->id
                        );
                        ...
                        if ($technicienResponsable) {
                            ...
                            Log::warning(
                                "Aucun technicien assigné pour la maintenance: " .
                                    $record->id
                            );
                        }
                    } catch (\Exception $e) {
    ...
    public function getFormSchema(): array
    {
        return [
            ...
            Forms\Components\DatePicker::make("date_debut")
                ...
                ->default(
                    fn($record, array $arguments) => Carbon::parse(
                        $arguments["start"]
                    )->format("Y-m-d H:i:s") ?? $record->date_debut
                )
            ...
            Forms\Components\DatePicker::make("date_fin")
                ...
                ->required()
                ->default(
                    fn($record, array $arguments) => $arguments["end"] ??
                        $record->date_fin
                )
                ->displayFormat("Y-m-d H:i:s")
            ...
            Forms\Components\Select::make("equipement_id")
                ...
                ->getOptionLabelFromRecordUsing(
                    fn($record) => $record->designation .
                        " - " .
                        $record->modele .
                        " - " .
                        $record->marque .
                        " - " .
                        $record->bloc->localisation
                ),
            ...
            Forms\Components\Hidden::make("statut")->default("planifiee"),
        ];
    }
        ...
        return [
            ...
            Actions\EditAction::make()
                ->mountUsing(function (
                    Forms\Form $form,
                    array $arguments,
                    MaintenancePreventive $record
                ) {
                    $form->fill([
                        "date_debut" => Carbon::parse(
                            $arguments["event"]["start"]
                        )->format("Y-m-d H:i:s"),
                    ...
                    try {
                        ...
                        if ($technicienResponsable) {
                            ...
                            $notification = Notification::make()
                                ...
                                ->body(
                                    "Une maintenance préventive a été modifiée"
                                )
                                ->success()
                                ->actions([
                                    Action::make("Voir plus")
...
JS;
        ...
        return MaintenancePreventive::query()
            ...
            ->map(
                fn(MaintenancePreventive $mp) => EventData::make()
                    ...
                    ->url(
                        url: MaintenancePreventiveResource::getUrl(
                            name: "view",
                            parameters: ["record" => $mp]
                        )
                    )
                    ->extendedProps([
                        "statut" => $mp->statut,
    ...
    protected function getListeners(): array
    {
        return array_merge(parent::getListeners(), [
            "echo:*.MaintenancePreventiveCreated,MaintenancePreventiveCreated" =>
                "refreshCalendar",
            "echo:*.MaintenancePreventiveUpdated,MaintenancePreventiveUpdated" =>
                "refreshCalendar",
        ]);
    }
}
