...
class AIService
{
    public function generateRecommendations($description, $equipmentInfo)
    {
        $recommandations = Prism::text()
            ...
            ->withPrompt("Générez des recommandations pour le problème suivant : $description. Voici les informations sur l'équipement : $equipmentInfo. Formatez la réponse sous forme des points (tirets)")
            ->asText();
